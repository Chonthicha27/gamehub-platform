...
.pfx-banner__overlay{
  ...
  inset:0;
  background:
    linear-gradient(180deg, rgba(5,7,12,.8), rgba(5,7,12,.75) 40%, rgba(5,7,12,.9));
}
.pfx-banner__inner{
  position:relative;
  z-index:1;
...
.pfx-skel.cover{
  ...
  animation:pfx-shimmer 1.2s infinite;
}
.pfx-skel.line{
  height:14px;
  margin:10px 12px;
