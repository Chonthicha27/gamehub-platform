...
function AuthShell({ initialMode = "signin" }) {
  ...
  return (
    <div className="auth-page">
      {/* --- scoped CSS: ไม่ต้องสร้างไฟล์ใหม่ --- */}
      <style>{`
        :root{
          --bg:#0b0f16; --panel:#101727; --text:#ecf0ff; --muted:#a7b4d8; --border:rgba(255,255,255,.08);
